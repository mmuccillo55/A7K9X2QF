...
Defaults:
    archivo : Chancho.xlsx
    salida  : connections2.json
...
XLSX_FILE = sys.argv[1] if len(sys.argv) > 1 else 'Chancho.xlsx'
JSON_FILE = sys.argv[2] if len(sys.argv) > 2 else 'connections2.json'
